...
- present compact scope beside each rule ([#164](https://github.com/nickderobertis/llmlint/pull/164))

## [0.3.23](https://github.com/nickderobertis/llmlint/compare/v0.3.22...v0.3.23) - 2026-07-19

### Added

- lint line attribution configuration ([#161](https://github.com/nickderobertis/llmlint/pull/161))
...
- read fallback winner from fallback.ran, not results[0] ([#147](https://github.com/nickderobertis/llmlint/pull/147))
